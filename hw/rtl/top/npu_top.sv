...
module npu_top (
  ...
  // AXI4 wires (arbiter m side -> MIG s_axi)
  logic [ 3:0] m_awid;
  logic [27:0] m_awaddr;
  logic [ 7:0] m_awlen;
  logic [ 2:0] m_awsize;
  ...
  axi_arbiter u_arbiter (
      ...
      .s0_awlen  (b_awlen),
      .s0_awsize (b_awsize),
      .s0_awburst(b_awburst),
      .s0_awlock (b_awlock),
      .s0_awcache(b_awcache),
      .s0_awprot (b_awprot),
      .s0_awqos  (b_awqos),
      .s0_awvalid(b_awvalid),
      .s0_awready(b_awready),
      .s0_wdata  (b_wdata),
      .s0_wstrb  (b_wstrb),
      .s0_wlast  (b_wlast),
      .s0_wvalid (b_wvalid),
      ...
      .s0_arlen  (b_arlen),
      .s0_arsize (b_arsize),
      .s0_arburst(b_arburst),
      .s0_arlock (b_arlock),
      .s0_arcache(b_arcache),
      .s0_arprot (b_arprot),
      .s0_arqos  (b_arqos),
      .s0_arvalid(b_arvalid),
      .s0_arready(b_arready),
      .s0_rid    (b_rid),
      .s0_rdata  (b_rdata),
      .s0_rresp  (b_rresp),
      .s0_rlast  (b_rlast),
      ...
      .s1_awlen  (n_awlen),
      .s1_awsize (n_awsize),
      .s1_awburst(n_awburst),
      .s1_awlock (n_awlock),
      .s1_awcache(n_awcache),
      .s1_awprot (n_awprot),
      .s1_awqos  (n_awqos),
      .s1_awvalid(n_awvalid),
      .s1_awready(n_awready),
      .s1_wdata  (n_wdata),
      .s1_wstrb  (n_wstrb),
      .s1_wlast  (n_wlast),
      .s1_wvalid (n_wvalid),
      ...
      .s1_arlen  (n_arlen),
      .s1_arsize (n_arsize),
      .s1_arburst(n_arburst),
      .s1_arlock (n_arlock),
      .s1_arcache(n_arcache),
      .s1_arprot (n_arprot),
      .s1_arqos  (n_arqos),
      .s1_arvalid(n_arvalid),
      .s1_arready(n_arready),
      .s1_rid    (n_rid),
      .s1_rdata  (n_rdata),
      .s1_rresp  (n_rresp),
      .s1_rlast  (n_rlast),
